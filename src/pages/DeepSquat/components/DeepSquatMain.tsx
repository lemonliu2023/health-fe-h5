...
function DeepSquat({ width, height, poseLandmarkerRef }: { width: number; height: number; poseLandmarkerRef: React.RefObject<PoseLandmarker | undefined> }) {
  ...
  return (
    <>
      ...
      <div style={{ display: enableCamera ? 'none' : 'block' }}>
        <Button fill onClick={enableCamHandler}>开始训练</Button>
      </div>
    </>
  );
}
